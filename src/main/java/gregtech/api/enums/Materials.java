...
public enum Materials implements IColorModulationContainer, ISubTagContainer {
	...
	Neutronium(129, TextureSet.SET_DULL, 6.0F, Integer.MAX_VALUE, 6, 1 | 2 | 8 | 32 | 64 | 128, 250, 250, 250, 0, "Neutronium", 0, 0, 10000, 0, false, false, 20, 1, 1, Dyes.dyeWhite, Element.Nt, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 4), new TC_AspectStack(TC_Aspects.VITREUS, 3), new TC_AspectStack(TC_Aspects.ALIENIS, 2))),
	...
	Soularium(-1, TextureSet.SET_DULL, 1.0F, 0, 2, 1, 95, 90, 54, 0, "Soularium", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes._NULL),
	...
	Cyanite(-1, TextureSet.SET_DULL, 1.0F, 0, 2, 1, 0,191,255, 0, "Cyanite", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes.dyeCyan),
	...
	Yellorium(-1, TextureSet.SET_DULL, 1.0F, 0, 2, 1 | 2, 240,230,140, 0, "Yellorium", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes.dyeYellow),
	...
	Monazite(520, TextureSet.SET_DIAMOND, 1.0F, 0, 1, 1 | 4 | 8, 50, 70, 50, 0, "Monazite", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes.dyeGreen, 1, Arrays.asList(new MaterialStack(RareEarth, 1), new MaterialStack(Phosphate, 1))), // Wikipedia: (Ce, La, Nd, Th, Sm, Gd)PO4 Monazite also smelt-extract to Helium, it is brown like the rare earth Item Monazite sand deposits are inevitably of the monazite-(Ce) composition. Typically, the lanthanides in such monazites contain about 45пїЅ48% cerium, about 24% lanthanum, about 17% neodymium, about 5% praseodymium, and minor quantities of samarium, gadolinium, and yttrium. Europium concentrations tend to be low, about 0.05% Thorium content of monazite is variable and sometimes can be up to 20пїЅ30%
	 ...
	 * 
	 */
	Staballoy(319, TextureSet.SET_ROUGH, 10.0F, 5120, 4, 1 | 2  | 16 | 32 | 64 | 128, 48, 55, 46, 0, "Staballoy", 0, 0, 1500, 2800, true, false, 1, 3, 1, Dyes.dyeGreen, 2, Arrays.asList(new MaterialStack(Titanium, 1), new MaterialStack(Uranium, 9)), Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 8), new TC_AspectStack(TC_Aspects.STRONTIO, 3))),
	Bedrockium(780, TextureSet.SET_FINE, 8.0F, 8196, 3, 1 | 2 | 16 | 32 | 64 | 128, 39, 39, 39, 0, "Bedrockium", 0, 0, -1, 0, false, false, 1, 5, 1, Dyes.dyeLightGray, 2, Arrays.asList(new MaterialStack(Carbon, 63), new MaterialStack(Carbon, 56)),   Arrays.asList(new TC_AspectStack(TC_Aspects.VACUOS, 8), new TC_AspectStack(TC_Aspects.TUTAMEN, 3))),
	BloodSteel(781, TextureSet.SET_METALLIC, 11.0F, 768, 4, 1 | 2 | 16 | 32 | 64 | 128, 142, 28, 0, 0, "Blood Steel", 0, 0, -1, 0, false, false, 1, 1, 1, Dyes.dyeRed, 2, Arrays.asList(new MaterialStack(Steel, 3)), Arrays.asList(new TC_AspectStack(TC_Aspects.VICTUS, 8), new TC_AspectStack(TC_Aspects.IGNIS, 3))),
	VoidMetal(782, TextureSet.SET_METALLIC, 6.0F, 1280, 3, 1 | 2 | 16 | 32 | 64 | 128, 82, 17, 82, 0, "Void Metal", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes.dyeBlack, Arrays.asList(new TC_AspectStack(TC_Aspects.PRAECANTATIO, 5), new TC_AspectStack(TC_Aspects.VACUOS, 7))),
	ConductiveIron(783, TextureSet.SET_METALLIC, 5.0F, 256, 2, 1 | 2, 164, 109, 100, 0, "Conductive Iron", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes.dyeRed, 2, Arrays.asList(new MaterialStack(Iron, 6), new MaterialStack(Redstone, 2)), Arrays.asList(new TC_AspectStack(TC_Aspects.POTENTIA, 2), new TC_AspectStack(TC_Aspects.METALLUM, 2))),
	ElectricalSteel(784, TextureSet.SET_METALLIC, 7.0F, 768, 3, 1 | 2 | 64 | 128, 194, 194, 194, 0, "Electrical Steel", 0, 0, 1811, 1000, true, false, 3, 1, 1, Dyes.dyeLightGray, 2, Arrays.asList(new MaterialStack(Iron, 3), new MaterialStack(Coal, 2), new MaterialStack(Silicon, 2)),   Arrays.asList(new TC_AspectStack(TC_Aspects.MAGNETO, 2), new TC_AspectStack(TC_Aspects.ELECTRUM, 5))),
	EnergeticAlloy(785, TextureSet.SET_SHINY, 5.0F, 512, 3, 1 | 2 | 64 | 128, 252, 152, 45, 0, "Energetic Alloy", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes.dyeOrange, 2, Arrays.asList(new MaterialStack(Gold, 3), new MaterialStack(Glowstone, 2), new MaterialStack(Redstone, 2)),  Arrays.asList(new TC_AspectStack(TC_Aspects.POTENTIA, 4), new TC_AspectStack(TC_Aspects.LUX, 3))),
	VibrantAlloy(786, TextureSet.SET_SHINY, 7.0F, 1280, 4, 1 | 2 | 64 | 128, 204, 242, 142, 0, "Vibrant Alloy", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes.dyeLime, 2, Arrays.asList(new MaterialStack(EnergeticAlloy, 1), new MaterialStack(EnderPearl, 3)), Arrays.asList(new TC_AspectStack(TC_Aspects.MACHINA, 5), new TC_AspectStack(TC_Aspects.TELUM, 4))),
	PulsatingIron(787, TextureSet.SET_SHINY, 5.0F, 256, 2, 1 | 2 | 64 | 128, 50, 91, 21, 0, "Pulsating Iron", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes.dyeGreen, 2, Arrays.asList(new MaterialStack(Iron, 2), new MaterialStack(EnderPearl, 2)), Arrays.asList(new TC_AspectStack(TC_Aspects.ALIENIS, 3), new TC_AspectStack(TC_Aspects.METALLUM, 3))),
	/* TODO*/ RedstoneAlloy(788, TextureSet.SET_METALLIC, 1.0F, 256, 2, 1|2|16|32|64, 178,34,34, 0, "Redstone Alloy", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes.dyeRed, 2, Arrays.asList(new MaterialStack(Iron, 2), new MaterialStack(Redstone, 4))),
	...
	//Does this work?
	/*
	 * (Ta - 10% W) → also called tantaloy 60 metal it uses 9 to 11% of tungsten, this alloy is less ductile than the other alloys,
	 *  with less plasticity the material can be used in different situations like in aerospace materials and furnaces. 
	 *  This alloy can also be used in some different applications like piping in nuclear plants.[1]
	 * 
	 * Alloys		Hardness (HV)	Density (g/cm3)	Melting Point (oC)	Tensile Strength (MPa)	Yield Strength (MPa)	Elastic Modulus (GPa)
		W 2.5%		130				16.7			3005				345						230						195
		W 7.5% 		245				16.8			3030				550						460						205
		W 10% 		325 - 400		16.8			3025				1035 - 1165				875 - 1005				200
	 * 
	 * 
	 */
	...
	@Deprecated Adamantium(Staballoy, true),
	...
	@Deprecated Adamant(Staballoy, true),
	...
	static {
		...
		Silicon.add(SubTag.FLAMMABLE, SubTag.NO_SMASHING, SubTag.BOUNCY, SubTag.STRETCHY);
		...
		ConductiveIron.add(SubTag.MORTAR_GRINDABLE);
		PulsatingIron.add(SubTag.MORTAR_GRINDABLE);
		RedstoneAlloy.add(SubTag.MORTAR_GRINDABLE);
		...
		VoidMetal.setEnchantmentForTools(Enchantment.fortune, 3);
		...
		HSLA.setEnchantmentForTools(Enchantment.sharpness, 4);
		...
		Staballoy				.setSpecialEffect(SpecialToolEffect.Crushing, 3);
